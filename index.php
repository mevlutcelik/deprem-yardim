...
<body>
  ...
  <section>
    ...
    <div class="col">
        <a href="<?= $domain ?>/yardim-cagrisi.php" class="btn btn-primary shadow btn-lg d-block w-100 float-right">Yardım Çağrısı</a>
    </div>
    </div>
    </div>
  </section>
    <section>
        <div class="container bg-dark py-5" style="display: flex; flex-direction: column;">
            ...
            <a class="btn btn-primary shadow" role="button" href="<?= $domain ?>/yardim-isteyenler.php">Listeyi görüntüle</a>
